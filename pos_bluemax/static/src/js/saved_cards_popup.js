odoo.define('pos_bluemax.CardNotPresentBlueMaxPayPayment2', function(require) {
    'use strict';
    ...
    class CardNotPresentBlueMaxPayPayment2 extends AbstractAwaitablePopup {
        constructor() {
            super(...arguments);
            // debugger;
            this.state = useState({
    ...
    // debugger;
    CardNotPresentBlueMaxPayPayment2.template = 'CardNotPresentBlueMaxPayPayment2';
    CardNotPresentBlueMaxPayPayment2.defaultProps = {
        confirmText: 'Ok',
        cancelText: 'Cancel',
        title: 'BlueMax Pay Payment',
        body: '',
    };
    Registries.Component.add(CardNotPresentBlueMaxPayPayment2);
    return CardNotPresentBlueMaxPayPayment2;
});