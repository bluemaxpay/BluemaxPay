odoo.define('pos_card_not_present.CardNotPresentBlueMaxPayPayment', function(require) {
    'use strict';
    ...
    const PosToken = (PosGlobalState) => class PosToken extends PosGlobalState {
        //@override
    ...
    Registries.Model.extend(PosGlobalState, PosToken);
    class CardNotPresentBlueMaxPayPayment extends AbstractAwaitablePopup {
        constructor() {
            super(...arguments);
            // debugger;
            this.state = useState({
    ...
    //Create bluemaxpay popup
    // debugger;
    CardNotPresentBlueMaxPayPayment.template = 'CardNotPresentBlueMaxPayPayment';
    CardNotPresentBlueMaxPayPayment.defaultProps = {
        confirmText: 'Ok',
        cancelText: 'Cancel',
        title: 'BlueMax Pay Payment',
        body: '',
    };
    Registries.Component.add(CardNotPresentBlueMaxPayPayment);
    return CardNotPresentBlueMaxPayPayment;
});